...
class ListPrefereAction extends Action
{
    public function execute():string{
        $html = "<div class ='LPA'><h3 id='LPA_h3'>La liste de vidéos préférées </h3><div class='LPA_1'><div class='LPA_2'>";

        $bdd = ConnectionFactory::makeConnection();
        $user = unserialize($_SESSION['user']);
        $id = $user->id;

        $resultSet_1 = $bdd->query("select id_serie from liste_epv where id = $id and estprefere = true");
        $resultSet_1->execute();
...
END;
    ...
    public static function ajoutPrefere($id_episode,$id_user){
        $bdd = ConnectionFactory::makeConnection();
